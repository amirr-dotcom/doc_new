                        ...
                        child: Container(
                            child: Column(
                              ...
                              CustomTextFormField(
                                  ...
                                  alignment: Alignment.center,
                                  suffix: Container(
                                      margin: getMargin(left: 30, bottom: 13),
                                      child: CommonImageView(
                              ...
                              Align(
                                  ...
                                  child: Padding(
                                      padding: getPadding(
                                          left: 30, top: 4, right: 30),
                                      child: Text("msg_password_must_b".tr,
                                          overflow: TextOverflow.ellipsis,
                                          textAlign: TextAlign.left,
                                          style: AppStyle.txtNunitoSemiBold10
                                              .copyWith()))),
                              CustomTextFormField(
                                  width: 368,
                                  focusNode: FocusNode(),
                                  ...
                                  hintText: "lbl".tr,
                                  margin:
                                      getMargin(left: 30, top: 30, right: 29),
                                  textInputAction: TextInputAction.done,
                                  alignment: Alignment.center,
                                  suffix: Container(
                                      margin: getMargin(
                                          left: 30, right: 1, bottom: 13),
                                      child: CommonImageView(
                                          svgPath: ImageConstant.imgClose)),
                                  suffixConstraints: BoxConstraints(
                                      minWidth: getHorizontalSize(20.00),
                              ...
                              Padding(
                                  padding:
                                      getPadding(left: 30, top: 4, right: 30),
                                  child: Text("lbl_don_t_match".tr,
                                      overflow: TextOverflow.ellipsis,
                                      textAlign: TextAlign.left,
                                      style: AppStyle.txtKumbhSansSemiBold10
                                          .copyWith())),
                              CustomButton(
                                  width: 368,
                                  text: "lbl_confirm".tr,
                                  margin: getMargin(
                                      left: 30, top: 72, right: 30, bottom: 20),
                                  alignment: Alignment.center)
                            ])))))));
  }
